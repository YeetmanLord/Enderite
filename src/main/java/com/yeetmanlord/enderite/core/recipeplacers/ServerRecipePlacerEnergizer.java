package com.yeetmanlord.enderite.core.recipeplacers;
...
public class ServerRecipePlacerEnergizer<C extends IInventory> extends ServerRecipePlacer<C> 
{
	private boolean matches;

	   public ServerRecipePlacerEnergizer(RecipeBookContainer<C> recipeBookContainer) {
	   ...
	   protected void func_201516_a(int p_201516_1_, IntList intList) {
